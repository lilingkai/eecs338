      ...
      for (i=2; i<= 10; i++) {
        if (sessionStorage.getItem("Avg"+i.toString()) === null) {
          ...
          if (Math.abs((current-previous)/previous*100) >= 10 && current-previous > 0) {
            ...
            last 10 percentile of papers is more than 10% higher than the previous \
            10 percentile! Review these previous papers to see if your grading \
            standards have changed over time!";
          }
          else {
            alert.innerHTML = "Alert: The average grade you have assigned to the \
            last 10 percentile of papers is more than 10% lower than the previous \
            10 percentile! Review these previous papers to see if your grading \
            standards have changed over time!";
          }
        }
